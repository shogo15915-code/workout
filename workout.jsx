      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 17, color: COLORS.text, whiteSpace: "nowrap" }}>
              {entry.exerciseName}
            </div>
            <input
              value={entry.note || ""}
              ...
              placeholder="コツ・メモ"
              style={{ ...noteInputStyle, flex: 1, minWidth: 0 }}
            />
          </div>
          {prevEntry && (
    ...
    <div style={{ background: COLORS.surface, border: `1px solid ${COLORS.borderSoft}`, borderRadius: 12, padding: "14px 14px 10px", marginBottom: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 17, color: COLORS.text, whiteSpace: "nowrap" }}>{entry.exerciseName}</div>
            <input
              value={entry.note || ""}
              onChange={(e) => onUpdate({ ...entry, note: e.target.value })}
              placeholder="コツ・メモ"
